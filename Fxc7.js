...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:Wiwod\n'
            + 'ORG:ownerWiwod;\n'
            + 'TEL;type=CELL;type=VOICE;waid=62857415175041\n'
            + 'END:VCARD'

prefix = "!"
name = "~ SINULL BOT"
rdaftar = "TERIMA KASIH TELAH DAFTAR MENJADI TEMEN SINULL BOT😁"
rmenu = "HAI TEMEN SINULL BOT👋 JANGAN LUPA NGOPII YAA:)"
botinfo = "NGOPI UDUD JAN LUPA KAWAN')
limitt = 10
memberLimit = 2
ban = []
premium = ["6285741517504@s.whatsapp.net"]
